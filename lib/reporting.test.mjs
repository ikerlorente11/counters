...
import {
  buildYearEndGroupedReport,
  buildYearEndReportText,
  buildYearSectionText,
  toggleExpandedReportYear,
} from "./reporting.js";
...
test("toggleExpandedReportYear expands and collapses a year entry", () => {
  assert.deepEqual(toggleExpandedReportYear([], "2025"), ["2025"]);
  assert.deepEqual(toggleExpandedReportYear(["2024", "2025"], "2025"), ["2024"]);
  assert.deepEqual(toggleExpandedReportYear(["2024"], "2025"), ["2024", "2025"]);
});